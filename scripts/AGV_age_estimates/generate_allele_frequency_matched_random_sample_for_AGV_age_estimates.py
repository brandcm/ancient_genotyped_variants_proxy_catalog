...
def main():
	variants = pd.read_csv('/wynton/group/capra/projects/ancient_genotyped_variants_proxy_catalog/data/AGV_age_estimates/high_quality_AGV_age_estimates_single_estimate_per_variant_non_missing_AF.txt', sep = '\t', header = 0)
	...
	random_variants.to_csv('/wynton/group/capra/projects/ancient_genotyped_variants_proxy_catalog/data/AGV_age_estimates/allele_frequency_matched_random_sample_for_AGV_age_estimates.txt', sep = '\t', header = True, index = False)
