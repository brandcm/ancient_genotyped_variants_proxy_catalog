#!/bin/bash
#$ -N retrieve_GWAS_largest_effect_loci_proxy_AFs
#$ -t 1-22
#$ -M colin.brand@ucsf.edu
#$ -m ae
#$ -cwd
#$ -o /wynton/group/capra/projects/ancient_genotyped_variants_proxy_catalog/scripts/selection_GWAS_loci_allele_frequency_trajectories/retrieve_GWAS_largest_effect_loci_proxy_AFs.out
#$ -e /wynton/group/capra/projects/ancient_genotyped_variants_proxy_catalog/scripts/selection_GWAS_loci_allele_frequency_trajectories/retrieve_GWAS_largest_effect_loci_proxy_AFs.err
#$ -l h_rt=2:00:00
#$ -l mem_free=10G
...
script="${project_directory}scripts/selection_GWAS_loci_allele_frequency_trajectories/retrieve_GWAS_largest_effect_loci_proxy_AFs.py"
