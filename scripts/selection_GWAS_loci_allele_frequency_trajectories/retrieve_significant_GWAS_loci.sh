...
zcat GCST90179150.h.tsv.gz | awk '($8 < 5e-8) {print "chr"$1,$2-1,$2,$3,$4,$9,$5,$7}' OFS='\t' - > "${output_directory}Koskeridis_et_al_2022_GCST90179150_BMI_significant_loci_hg38_betas_and_AFs.bed"
...
zcat GCST90245992.h.tsv.gz | awk '($8 < 5e-8) {print "chr"$1,$2-1,$2,$3,$4,$9,$5,$7}' OFS='\t' - > "${output_directory}Yengo_et_al_2022_GCST90245992_significant_loci_hg38_betas_and_AFs.bed"
