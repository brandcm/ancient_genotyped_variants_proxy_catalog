...
def parse_args():
	...
	parser.add_argument('--population', type=str, required=True, help='Population from which to identify variants in LD. AFR, EAS, EUR, or SAS.')
...
def identify_variants_in_LD(dictionary, chromosome, population, LD_directory, out_directory, rsID_mapping):
